# RanksDB
## Demo
Here is a rough demo that utilizes the full example of this library mentioned below: [Ionic PouchDB](https://ionic-pouchdb-d0f37.firebaseapp.com) . You can create an account and then login. There's few actions relatings authors and books that you can do.
## Full Example
